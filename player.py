...
simulate_games('Detroit Pistons','Philadelphia 76ers')
simulate_games('Golden State Warriors','Boston Celtics')
simulate_games('Washington Wizards','New Orleans Pelicans')
simulate_games('Minnesota Timberwolves','Denver Nuggets')
simulate_games('Portland Trail Blazers','Phoenix Suns')
